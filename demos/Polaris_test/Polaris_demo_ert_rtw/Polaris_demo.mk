...
MODEL                   = Polaris_demo
MODULES                 = Polaris_demo_data.c 
MAKEFILE                = Polaris_demo.mk
MATLAB_ROOT             = /home/pi/MATLAB
ALT_MATLAB_ROOT         = /home/pi/MATLAB
MASTER_ANCHOR_DIR       = 
START_DIR               = /home/pi/RTW/Polaris_demo
S_FUNCTIONS             = rpi_sfun_cpu_wrapper.c rpi_sfun_polaris_wrapper.c
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNX
...
CPP                 = g++
LD                  = gcc
DEFAULT_OPT_OPTS    = -Ofast -mfpu=vfp -mfloat-abi=hard -march=armv6zk -mtune=arm1176jzf-s
LDFLAGS             = 
SHRLIBLDFLAGS       = -shared -Wl,--no-undefined -Wl,--version-script,
ANSI_OPTS           = -std=gnu99 -pedantic
CPP_ANSI_OPTS       =
GCC_WALL_FLAG       = -Wall -W -Wwrite-strings -Winline -Wstrict-prototypes -Wnested-externs -Wpointer-arith
GCC_WALL_FLAG_MAX   = $(GCC_WALL_FLAG) -Wshadow
...
%.o : /home/pi/MATLAB/blocks/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

# Disable C automatic rules expanding
#%.o : $(MATLAB_ROOT)/rtw/c/src/%.c
#	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
#
#%.o : C:/Users/jacques/Documents/MATLAB/rpit/blocks/%.c
#	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
#
#
...
%.o : /home/pi/MATLAB/blocks/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

# Disable CPP automatic rules expanding
#%.o : $(MATLAB_ROOT)/rtw/c/src/%.cpp
#	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
#
#%.o : C:/Users/jacques/Documents/MATLAB/rpit/blocks/%.cpp
#	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
#
#
