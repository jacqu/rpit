...
#ifndef RTW_HEADER_jitter_types_h_
#define RTW_HEADER_jitter_types_h_
#include "rtwtypes.h"

/* Parameters (auto storage) */
typedef struct Parameters_jitter_ Parameters_jitter;

/* Forward declaration for rtModel */
typedef struct RT_MODEL_jitter RT_MODEL_jitter;

#endif                                 /* RTW_HEADER_jitter_types_h_ */
