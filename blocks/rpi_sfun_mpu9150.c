...
#define S_FUNCTION_NAME rpi_sfun_mpu9150
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void rpi_sfun_mpu9150_Outputs_wrapper(real_T *ax,
                          real_T *ay,
                          real_T *az,
                          real_T *gx,
                          real_T *gy,
...
{
    real_T        *ax  = (real_T *)ssGetOutputPortRealSignal(S,0);
    ...
    real_T        *mx  = (real_T *)ssGetOutputPortRealSignal(S,6);
    real_T        *my  = (real_T *)ssGetOutputPortRealSignal(S,7);
    real_T        *mz  = (real_T *)ssGetOutputPortRealSignal(S,8);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T  *rpi_Ts  = (const real_T *)mxGetData(PARAM_DEF0(S));

    rpi_sfun_mpu9150_Outputs_wrapper(ax, ay, az, gx, gy, gz, mx, my, mz, rpi_Ts, p_width0);
}
