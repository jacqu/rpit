...
#define S_FUNCTION_NAME rpi_sfun_js
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void rpi_sfun_js_Outputs_wrapper(real_T *Axes,
                          real_T *Buttons  , 
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    rpi_sfun_js_Outputs_wrapper(Axes, Buttons, rpi_ID, p_width0, rpi_Ts, p_width1);
}
