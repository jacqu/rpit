 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Feb 06 17:15:19 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME rpi_sfun_xboxone
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NPARAMS               2
/* Parameter 0 */
#define PARAMETER_0_NAME      rpi_ID
#define PARAMETER_0_DTYPE     real_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO
/* Parameter 1 */
#define PARAMETER_1_NAME      rpi_Ts
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *rpi_ID = (const real_T *) mxGetData(PARAM_DEF0(S));
    const real_T *rpi_Ts = (const real_T *) mxGetData(PARAM_DEF1(S));
    
    rpi_sfun_xboxone_Outputs_wrapper(Axes, Buttons, rpi_ID, p_width0, rpi_Ts, p_width1);
