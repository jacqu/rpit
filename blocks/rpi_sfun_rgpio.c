...
#define S_FUNCTION_NAME rpi_sfun_rgpio
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          6
/* Input Port  0 */
#define IN_PORT_0_NAME      pin11
...
{
    const real_T   *pin11  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *pin13  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *pin15  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *pin29  = (const real_T*) ssGetInputPortSignal(S,3);
    const real_T   *pin31  = (const real_T*) ssGetInputPortSignal(S,4);
    const real_T   *pin37  = (const real_T*) ssGetInputPortSignal(S,5);
    real_T        *pin12  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *pin16  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *pin18  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *pin22  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *pin36  = (real_T *)ssGetOutputPortRealSignal(S,4);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T  *rpi_Ts  = (const real_T *)mxGetData(PARAM_DEF0(S));

    rpi_sfun_rgpio_Outputs_wrapper(pin11, pin13, pin15, pin29, pin31, pin37, pin12, pin16, pin18, pin22, pin36, rpi_Ts, p_width0);
}
