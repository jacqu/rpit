...
#define LSM303_OUT_Y_H_M         0x07   // The addresses of the Y and Z magnetometer output registers 
#define LSM303_OUT_Y_L_M         0x08   // are reversed on the DLM and DLHC relative to the DLH.
