...
#define S_FUNCTION_NAME rpi_sfun_ev3
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void rpi_sfun_ev3_Outputs_wrapper(const real_T *u_A,
                          const real_T *u_B,
                          const real_T *u_C,
                          const real_T *u_D,
                          real_T *y_A,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *u_D  = (const real_T*) ssGetInputPortSignal(S,3);
    ...
    real_T        *y_D  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *y_1  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *y_2  = (real_T *)ssGetOutputPortRealSignal(S,5);
    real_T        *y_3  = (real_T *)ssGetOutputPortRealSignal(S,6);
    real_T        *y_4  = (real_T *)ssGetOutputPortRealSignal(S,7);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T  *rpi_Ts  = mxGetData(PARAM_DEF0(S));

    rpi_sfun_ev3_Outputs_wrapper(u_A, u_B, u_C, u_D, y_A, y_B, y_C, y_D, y_1, y_2, y_3, y_4, rpi_Ts, p_width0);
}
