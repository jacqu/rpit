...
#define S_FUNCTION_NAME rpi_sfun_resetusb
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    rpi_sfun_resetusb_Start_wrapper(rpi_Ts, p_width0);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    rpi_sfun_resetusb_Outputs_wrapper(err, rpi_Ts, p_width0);
