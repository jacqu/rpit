...
#define S_FUNCTION_NAME rpi_sfun_ev314
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          4
/* Input Port  0 */
#define IN_PORT_0_NAME      UA
...
{
    const real_T   *UA  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *UB  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *UC  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *UD  = (const real_T*) ssGetInputPortSignal(S,3);
    real_T        *EA  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *EB  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *EC  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *ED  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *S1  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *S2  = (real_T *)ssGetOutputPortRealSignal(S,5);
    real_T        *S3  = (real_T *)ssGetOutputPortRealSignal(S,6);
    real_T        *S4  = (real_T *)ssGetOutputPortRealSignal(S,7);
    real_T        *IBAT  = (real_T *)ssGetOutputPortRealSignal(S,8);
    real_T        *VBAT  = (real_T *)ssGetOutputPortRealSignal(S,9);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const real_T  *rpi_Ts  = (const real_T *)mxGetData(PARAM_DEF0(S));
    const uint8_T  *rpi_ID  = (const uint8_T *)mxGetData(PARAM_DEF1(S));

    rpi_sfun_ev314_Outputs_wrapper(UA, UB, UC, UD, EA, EB, EC, ED, S1, S2, S3, S4, IBAT, VBAT, rpi_Ts, p_width0, rpi_ID, p_width1);
}
