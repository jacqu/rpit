...
#define S_FUNCTION_NAME sfun_OSEK_i2c_recieve
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      newdata
...
#define SOURCEFILES "__SFB__SRC_PATH C:\RTtools\nxtOSEK\ecrobot\c__SFB__INC_PATH C:\RTtools\nxtOSEK\ecrobot\nxtway_gs_balancer__SFB__INC_PATH C:\RTtools\nxtOSEK\lejos_nxj\src\nxtvm\platform\nxt__SFB__INC_PATH C:\RTtools\nxtOSEK\lejos_nxj\src\nxtvm\javavm__SFB__INC_PATH C:\RTtools\nxtOSEK\ecrobot\c__SFB__INC_PATH C:\RTtools\nxtOSEK\ecrobot\c\nxt__SFB__ecrobot_interface.c"
#define PANELINDEX           6
   ...
   /* Function: mdlCheckParameters =============================================
    ...
    static void mdlCheckParameters(SimStruct *S)
    {
...

	 {
	  ...
	  if (!mxIsDouble(pVal4)) {
	    ssSetErrorStatus(S,"Sample time parameter st must be of type double");
	    return; 
	  }
	 }
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetOutputPortWidth(S, 0, *(const real_T *)mxGetData(PARAM_DEF3(S)));
...
{
    ssSetSampleTime(S, 0, *mxGetPr(ssGetSFcnParam(S, 4)));
...
{
    uint8_T        *newdata  = (uint8_T *)ssGetOutputPortRealSignal(S,0);
    ...
    const real_T  *addr  = (const real_T *)mxGetData(PARAM_DEF1(S));
    const real_T  *intreg  = (const real_T *)mxGetData(PARAM_DEF2(S));
    const real_T  *buflen  = (const real_T *)mxGetData(PARAM_DEF3(S));
    const real_T  *st  = (const real_T *)mxGetData(PARAM_DEF4(S));
