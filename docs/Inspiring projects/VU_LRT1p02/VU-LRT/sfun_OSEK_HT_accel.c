 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Wed Jul 21 10:48:07 2010
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfun_OSEK_HT_accel
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SAMPLE_TIME_0        ((real_T) mxGetPr(ssGetSFcnParam(S,1))[0])
...
{
    int16_T        *x  = (int16_T *)ssGetOutputPortRealSignal(S,0);
    int16_T        *y  = (int16_T *)ssGetOutputPortRealSignal(S,1);
    int16_T        *z  = (int16_T *)ssGetOutputPortRealSignal(S,2);
