/*
 * File: sfun_OSEK_usbinterface_r.c
 *
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Aug 23 16:18:21 2011
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfun_OSEK_usbinterface_r
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NPARAMS              2
/* Parameter  1 */
#define PARAMETER_0_NAME      init_y0
#define PARAMETER_0_DTYPE     uint8_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO
/* Parameter  2 */
#define PARAMETER_1_NAME      st
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint8_T        *size  = (uint8_T *)ssGetOutputPortRealSignal(S,1);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const uint8_T  *init_y0  = (const uint8_T *)mxGetData(PARAM_DEF0(S));
    const real_T  *st  = (const real_T *)mxGetData(PARAM_DEF1(S));
